...
public class AudioRestAreaManager : MonoBehaviour
{
    public static AudioRestAreaManager Instance { get; private set; }
    ...
    public AudioClip purchaseSFX;     // Âm thanh mua item thành công
    public AudioClip errorSFX;        // Âm thanh lỗi/không đủ tiền

...
public class AudioCasinoManager : MonoBehaviour
{
    public static AudioCasinoManager Instance { get; private set; }
    ...
    void Awake()
    {
        // Singleton cho scene hiện tại (không dùng DontDestroyOnLoad)
        Instance = this;
